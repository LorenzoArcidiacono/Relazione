...
Viene inoltre avviato il controllo periodico, mediante la funzione built-in \jscode{setInterval}, della connessione (Listing \ref*{lst:checkconnection}): viene quindi periodicamente fatta una chiamata HTTP a un URL predefinito e si controlla che questa vada a buon fine (vedi \ref*{connection}).

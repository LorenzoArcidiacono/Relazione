...
\nl
Le modifiche impostate dal backoffice vengono comunicate al dispositivo che, tramite le interfacce offerte dal sistema, scrive i file necessari alla persistenza delle informazioni, scarica gli assets che devono essere accessibili offline (immagini e video) e setta le impostazioni selezionate.}

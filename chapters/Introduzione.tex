...
É possibile riferire l'immagine, una volta assegnatagli una reference, tramite il comando \text{\textbackslash autoref\{fig:immagine\}}, ottenendo il seguente risultato: \autoref{fig:immagine}.
...
\lstinputlisting[language=JavaScript]{listings/StatoArte/code1.cpp} 
